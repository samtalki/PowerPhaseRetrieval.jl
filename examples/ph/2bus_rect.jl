...
# ╔═╡ 42a96d23-0f99-4c08-b5a7-5e1350268238
using LinearAlgebra,Plots,JuMP,SCS,Distributions,Random,LaTeXStrings

# ╔═╡ d0ee686c-cedf-4018-af36-8a0f14b03675
begin
	...
	#flat start for state -- e2;f2 -- guess 1;0
	x0 = [1,0]

end

# ╔═╡ c465811a-d211-449e-8086-f5e72233d664
"""
Admittance matrix
"""
Y(g,b) = [
...
# ╔═╡ 5a2cdde3-94a7-4c99-9628-e7858c0a7e2d
"""
real power balance
"""
p(x) = g*( x[1]^2 + x[2]^2 - x[1] ) -b*x[2]

# ╔═╡ 178b02c7-6f8a-4f87-bd5a-6aaba6ef6300
"""
reactive power balance
"""
q(x) = -b*( x[1]^2 + x[2]^2 - x[1]) - g*x[2]

# ╔═╡ 980e69b9-9cf7-469d-84da-d1df3082901a
"""
Mismatches
"""
f(x) = [
...
# ╔═╡ 89cef1c2-383c-443c-bf01-dd572269a129
"""
Rectangular power flow jacobian
"""
J(x) = [
	g*(2*x[1] - 1)  2*g*x[2]-b ;
	-b*(2*x[1] - 1)  -2*x[2]*b - g
...
# ╔═╡ 6d21afbe-66c6-11ed-0983-dd792bf72cc7
"""
...
# ╔═╡ 1a74c39c-7095-41bb-9cca-a7c362084a50
