...
# ╔═╡ 812e350a-6670-11ed-33ac-4ba56d751bb1
using LinearAlgebra,Plots,JuMP,SCS,Distributions,Random,LaTeXStrings

# ╔═╡ dc3d9df9-1897-4a3c-84d2-6ab5b5413243
#Two bus test case for the NR phase retrieval alg
begin
...
# ╔═╡ 01d8a7c4-a577-4bbe-92bc-7ccf75b77de5
...
# ╔═╡ ec674ea3-6c0f-42e2-8a92-38b965a66d81
"""
...
# ╔═╡ fa85569f-3181-436b-a9a9-66055e7387d1
begin #Jacobian Block functions
	dpdθ(x) = 10*x[2]*cos(x[1])
	dpdv(x) = 10*sin(x[1])
	dqdθ(x) = 10*x[2]*sin(x[1])
	dqdv(x) = -10*cos(x[1]) + 20*x[2]
end

# ╔═╡ 67038356-a936-476e-9d16-94a42f5066fe
"""
...
# ╔═╡ 9cd32468-4699-4127-beaa-107861934645
"""
θ-free Newton-Raphson Power Flow Jacobian
"""
Jph(x) = [
...
# ╔═╡ 2004a5b3-4cf8-43c7-bf34-328c01e907fd


# ╔═╡ a2dbb986-4caa-418b-9b25-bd521e5f310e
"""
...
# ╔═╡ 70029c80-1659-4269-b93b-4d354ff28835
...
# ╔═╡ 5ad24aeb-899e-4ec3-a4bb-00a40e31e872
f_iter,x_iter,J_iter = nr_pf(x0)

# ╔═╡ 0f5c5e12-0a8b-4087-bc26-1e016a1ff872
fph_iter,xph_iter,Jph_iter = θfree_nr_pf(x0)

# ╔═╡ 966d2119-c98e-42d9-bee3-344cc4371ba4
begin
	...
	#savefig("/home/sam/github/PowerSensitivities.jl/figures/fall_22/2bus_iterations.pdf")
end

# ╔═╡ 234e3b0d-d31e-482f-ba6b-12768af7699d


# ╔═╡ 162c95cb-5f96-40b8-897a-2c4af5bb65dd


# ╔═╡ d997d6fb-5130-417c-afd2-ffad89eb422b
function test_phaseless_nr_solve(n_d = Normal(μ=0,σ=0.01))
	Xhat,Xhatf = [],[]
	for (J_i,f_i,x_i) in zip(Jph_iter,fph_iter,xph_iter)
		f_obs = J_i*x_i + rand(n_d,2)
		J_ph_i = Jph(x_i)
		xhat_i = inv(J_i)*f_obs
		xhat_ph_i = inv(J_ph_i)*f_obs
		push!(Xhat,xhat_i)
		push!(Xhatf,xhat_phi_i)
	end
	plot!()
